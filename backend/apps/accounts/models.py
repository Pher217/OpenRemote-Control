...
class Account(models.Model):
    ...
    encrypted_credential = models.BinaryField(null=True, blank=True)
    credential_key_id = models.CharField(max_length=255, blank=True)
    credential_recipient = models.CharField(max_length=255, blank=True)
